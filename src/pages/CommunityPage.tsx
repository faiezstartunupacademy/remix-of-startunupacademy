...
const CommunityPage = () => {
  ...
  const spaces = [
    ...
    { title: "Devenir Formateur STARTUNUP", description: "Animez une formation (15+ participants) et débloquez l'accès complet au Pôle Stratégique. Système d'évaluation intégré.", icon: Award, href: "/communaute/devenir-formateur", color: "from-primary/20 to-purple-500/20", iconColor: "text-primary", borderColor: "border-primary/40", features: ["≥ 15 participants", "Évaluation auto", "Délai 15j/thème", "Accès stratégique"], badge: "Nouveau", badgeVariant: "default" as const, accessible: true },
